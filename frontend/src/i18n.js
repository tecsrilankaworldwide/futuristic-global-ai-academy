...
const resources = {
  en: {
    translation: {
      ...
      "hero.subtitle": "Learn AI & Computer Science through fun, hands-on activities — no computers needed!",
  ...
  ta: {
    translation: {
      ...
      "hero.title": "அன்ப்ளக்டு AI அகாடமி",
      "hero.subtitle": "கணினிகள் இல்லாமல் வேடிக்கையான, கைகளில் செய்யும் செயல்பாடுகள் மூலம் AI மற்றும் கணினி அறிவியலைக் கற்றுக்கொள்ளுங்கள்!",
  ...
  si: {
    translation: {
      ...
      "hero.title": "අන්ප්ලග්ඩ් AI ඇකඩමිය",
      "hero.subtitle": "පරිගණක නොමැතිව AI සහ පරිගණක විද්‍යාව ප්‍රියජනක ක්‍රියාකාරකම් හරහා ඉගෙන ගන්න!",
  ...
  hi: {
    translation: {
      ...
      "hero.title": "अनप्लग्ड AI एकेडमी",
      "hero.subtitle": "कंप्यूटर के बिना मज़ेदार, हाथों-हाथ गतिविधियों के माध्यम से AI और कंप्यूटर विज्ञान सीखें!",
