"""
Seed 18 curated unplugged activities for AI + Computer Science learning
...
ACTIVITIES = [
    ...
    },
    {
        ...
        "instructions": [
            ...
            "Examples: 'see you tomorrow' to 'c u 2moro', 'AAA' to '3A'",
    ...
    },
    {
        ...
        "instructions": [
            ...
            "Example with shift 3: A becomes D, B becomes E, HELLO becomes KHOOR",
            "Teams create encrypted messages",
            "Exchange messages and try to decrypt them",
            "Discuss frequency analysis to crack codes",
            "Explore modern encryption: why simple ciphers are not secure"
        ],
        "learning_objectives": [
            "Basic encryption",
    ...
    },
    {
        ...
        "instructions": [
            ...
            "Create decision tree: Does it fly? Yes then Bird/Butterfly, No then ...",
